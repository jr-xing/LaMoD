...
class Generic_TransUNet_max_ppbp(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        self.conv_kwargs['kernel_size'] = self.conv_kernel_sizes[num_pool-1]
        self.conv_kwargs['padding'] = self.conv_pad_sizes[num_pool-1]
        ...
        if self.is_max:
            ...
            if self.is_masked_attn:
                ...
                from models.reconstruction.TransUNet3D.nn_transunet.networks.mask2former_modeling.transformer_decoder.mask2former_transformer_decoder3d import MultiScaleMaskedTransformerDecoder3d
                ...
                # edit by Jerry
                from models.reconstruction.TransUNet3D.nn_transunet.networks.mask2former_modeling.transformer_decoder.maskformer_transformer_decoder3d import SelfAttentionLayer
