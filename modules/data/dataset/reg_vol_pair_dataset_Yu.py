...
class RegVolPairDatasetYu(TorchDataset):
    """
    Simplified RegVolPairDataset class. Specifically for data structure of Yu's data.
    """
    def __init__(self, data, augmentation=None, config=None, full_config=None, dataset_name=None):
        ...
        self.img_key = config.get('img_key', 'input_rescaled')
